...
const courseReducer = createSlice({
  ...
  reducers: {
    ...
    getCoursesSearchListAction: (state, action) => {
...
export const { getCoursesAction, getCategoryAction, getCoursesByCategoryAction, getCourseDetailAction, getCoursesSearchListAction } = courseReducer.actions
...
export const courseSearchList = (tuKhoa: any) => {
  return async (dispatch: DispatchType) => {
    try {
      const res = await http.get(`/api/QuanLyKhoaHoc/LayDanhSachKhoaHoc?tenKhoaHoc=${tuKhoa}&MaNhom=GP01`)

      const action: PayloadAction<CourseItem[]> = getCoursesAction(res.data);
